<script>
    ...
    let index;
    const count = writable(Date.now());
    $: newLine = { id: Math.random(), key: "", value: "" };
...
<style>
    ...
    .hm-table-row:nth-child(even) {
        background-color: rgba(248, 250, 252, 0.5); /* 极浅的斑马纹 */
    }
    .hm-table-row:hover {
    ...
    :global(.hm-table-row .bx--text-input:focus) {
        ...
        box-shadow: inset 0 0 0 2px var(--brand-primary) !important; /* 内部描边聚焦 */
